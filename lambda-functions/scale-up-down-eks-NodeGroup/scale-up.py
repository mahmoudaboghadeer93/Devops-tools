...
def lambda_handler(event, context):
    auto_scaling_groups = [
        {'name': 'eks-node-group-name-1', 'min_size': 1, 'desired_capacity': 4, 'max_size': 8},
        {'name': 'eks-node-group-name-2', 'min_size': 1, 'desired_capacity': 3, 'max_size': 6}
    ...
    message_to_send = ':k8s: *Staging Scaled UP* :white_check_mark:'
